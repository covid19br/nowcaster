...
`r badge_github_version("nowcaster", "blue")`
<!-- `r badge_bioc_download("nowcaster", "total", "blue", "total")`  -->
<!-- `r badge_github_actions("covid19br/nowcaster")` -->
...
```{r INLA, eval=FALSE, echo = TRUE, message=FALSE, warning=FALSE, include=FALSE, paged.print=FALSE}
...
```{r, install, eval=FALSE, echo = TRUE, message=FALSE, warning=FALSE, include=FALSE, paged.print=FALSE}
