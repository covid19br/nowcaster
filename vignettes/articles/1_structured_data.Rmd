...
As in the [Get Started]("vignettes/nowcaster.Rmd") we start by loading the package and its lazy data, by:
...
The [Get Started]("vignettes/nowcaster.Rmd") example is done on non-structured data, here we give a more detailed description of this type of data and how it can change the nowcasting.
