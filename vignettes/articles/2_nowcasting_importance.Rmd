...
# We now call an internal function to construct a count of cases by age to each date of onset
data_by_week <- nowcaster:::data.w_no_age(dataset = srag_now, 
