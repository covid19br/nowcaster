...
```{r install}
remotes::install_github("covid19br/nowcaster/tree/dev")
```
...
dados_by_week<-nowcasting_bh$dados %>% 
...
nowcasting_bh$total %>% 
  ...
  geom_ribbon(aes(ymin = LI, ymax = LS, col = 'IC'), alpha = 0.3)+
  theme_bw()+
  theme(legend.position = "bottom", axis.text.x = element_text(angle = 90))+
  scale_color_manual(values = c('grey80', 'black'), name = '')+
